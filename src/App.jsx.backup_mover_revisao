    ...
    },
    {
      ...
      question: {
        ...
        },
        {
          ...
          sections: [
            {
      title: "Avaliação por Classe",
      content: `
        <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h3 style="color: #0369a1; margin-bottom: 15px;">📊 Pensamento por Classe de Antibióticos</h3>
          <p style="font-size: 16px; line-height: 1.6; margin-bottom: 15px;">
            Ao interpretar um antibiograma, é fundamental <strong>avaliar por classe de antibióticos</strong>, 
            não apenas antibióticos individuais. Se houver resistência a um representante da classe, 
            considere a possibilidade de <strong>toda a classe ser comprometida</strong>, mesmo que 
            haja eventual sensibilidade a outro membro.
          </p>
          
          <div style="background: #dbeafe; padding: 20px; border-radius: 8px; margin: 15px 0;">
            <h4 style="color: #1e40af; margin-bottom: 15px;">🔍 Por Que Pensar por Classe?</h4>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Mecanismos de resistência compartilhados:</strong> Mutações ou enzimas afetam toda a classe</li>
              <li><strong>Resistência cruzada:</strong> Resistência a um implica resistência a outros</li>
              <li><strong>Predição de falha terapêutica:</strong> Evitar usar antibiótico "S" que pode falhar</li>
              <li><strong>Segurança do paciente:</strong> Reduzir risco de tratamento inadequado</li>
            </ul>
          </div>
        </div>
        
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #d97706; margin-bottom: 15px;">⚠️ Quinolonas: O Exemplo Clássico</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            As <strong>quinolonas</strong> são o exemplo mais comum de resistência cruzada dentro 
            de uma classe. Resistência a uma quinolona frequentemente indica resistência a todas.
          </p>
          
          <div style="background: #fffbeb; padding: 20px; border-radius: 8px; margin: 15px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">🧬 Mecanismo de Resistência</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              Quinolonas inibem <strong>DNA girase (GyrA/GyrB)</strong> e <strong>topoisomerase IV (ParC/ParE)</strong>. 
              Mutações nesses genes conferem resistência a <strong>toda a classe</strong>:
            </p>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Mutação em gyrA:</strong> Resistência de alto nível a todas as quinolonas</li>
              <li><strong>Mutação em parC:</strong> Resistência adicional, especialmente em Gram-positivos</li>
              <li><strong>Bombas de efluxo:</strong> Expulsam todas as quinolonas</li>
              <li><strong>Alteração de permeabilidade:</strong> Reduz entrada de todas as quinolonas</li>
            </ul>
          </div>
          
          <div style="background: #fee2e2; padding: 20px; border-radius: 8px; margin: 15px 0;">
            <h5 style="color: #dc2626; margin-bottom: 10px;">📋 Exemplo Prático: Quinolonas</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Caso:</strong> <em>E. coli</em> isolada de urina
            </p>
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
              ...
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Ácido nalidíxico</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">> 256</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #dc2626; font-weight: bold;">R</td>
              </tr>
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Ciprofloxacino</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">2</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #059669; font-weight: bold;">S</td>
              </tr>
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Levofloxacino</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">1</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #059669; font-weight: bold;">S</td>
              </tr>
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Norfloxacino</strong></td>
            ...
            <div style="background: #fef2f2; padding: 15px; border-radius: 8px; margin: 10px 0;">
              <h6 style="color: #991b1b; margin-bottom: 10px;">⚠️ Interpretação Crítica</h6>
              <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
                Apesar de ciprofloxacino, levofloxacino e norfloxacino serem reportados como "S", 
                a <strong>resistência ao ácido nalidíxico</strong> é um <strong>marcador de mutação em gyrA</strong>.
              </p>
              <p style="font-size: 14px; line-height: 1.6; font-weight: bold; color: #dc2626;">
                <strong>Recomendação:</strong> Evitar quinolonas, mesmo as "sensíveis", pois há alto 
                risco de falha terapêutica. A CIM está próxima ao ponto de corte e pode subir durante o tratamento.
              </p>
            </div>
          </div>
        </div>
        ...
        <div style="background: #dcfce7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #059669; margin-bottom: 15px;">📚 Outras Classes com Resistência Cruzada</h4>
          
          <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
            <tr style="background: #10b981; color: white;">
              <th style="padding: 10px; border: 1px solid #ddd;">Classe</th>
              <th style="padding: 10px; border: 1px solid #ddd;">Mecanismo de Resistência</th>
              <th style="padding: 10px; border: 1px solid #ddd;">Resistência Cruzada</th>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Macrolídeos</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Metilação do ribossomo (erm)</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Azitromicina, claritromicina, eritromicina</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Aminoglicosídeos</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Enzimas modificadoras (AAC, ANT, APH)</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Pode afetar múltiplos aminoglicosídeos</td>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Tetraciclinas</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Bombas de efluxo (tet)</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Doxiciclina, minociclina, tetraciclina</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>β-lactâmicos</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">β-lactamases (ESBL, AmpC, KPC)</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Depende do tipo de enzima</td>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Glicopeptídeos</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Alteração do alvo (vanA, vanB)</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Vancomicina, teicoplanina</td>
            </tr>
          </table>
        </div>
        
        <div style="background: #eef2ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #4338ca; margin-bottom: 15px;">✅ Recomendações Práticas</h4>
          <ol style="margin-left: 20px; line-height: 1.8;">
            <li><strong>Identifique a classe:</strong> Agrupe antibióticos por mecanismo de ação</li>
            <li><strong>Procure padrões:</strong> Resistência a um = suspeite de resistência a todos</li>
            <li><strong>Considere mecanismos:</strong> Entenda como a resistência afeta a classe</li>
            <li><strong>Seja conservador:</strong> Em dúvida, evite a classe inteira</li>
            <li><strong>Consulte especialista:</strong> Em casos complexos, busque orientação</li>
          </ol>
        </div>
        ...
        <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; border-left: 4px solid #0ea5e9; margin: 15px 0;">
          <h4 style="color: #0369a1; margin-bottom: 10px;">💡 Mensagem Chave</h4>
          <p style="font-size: 14px; line-height: 1.6;">
            <strong>Pense por classe, não por antibiótico individual.</strong> Resistência a um 
            representante frequentemente indica comprometimento de toda a classe, especialmente 
            em quinolonas, macrolídeos e glicopeptídeos. Avaliação crítica do padrão de resistência 
            previne falhas terapêuticas.
          </p>
        </div>
      `,
      question: {
        text: "Por que é importante avaliar o antibiograma por classe de antibióticos?",
        options: [
          "Porque a resistência a um antibiótico de uma classe pode indicar comprometimento de toda a classe, como frequentemente ocorre com as quinolonas",
          "Porque cada antibiótico atua de forma completamente independente, sem relação entre os da mesma classe",
          "Porque a resistência a um antibiótico garante sensibilidade aumentada aos demais da mesma classe"
        ],
        correct: 0,
        explanation: "Avaliar por classe é fundamental porque mecanismos de resistência frequentemente afetam toda a classe de antibióticos. Exemplo clássico: quinolonas - mutações em gyrA/parC conferem resistência cruzada a todas as quinolonas (ciprofloxacino, levofloxacino, norfloxacino). Resistência ao ácido nalidíxico é marcador de mutação em gyrA, indicando que outras quinolonas podem falhar mesmo se reportadas como 'S'. Outras classes com resistência cruzada: macrolídeos (metilação ribossomal), glicopeptídeos (alteração de alvo), aminoglicosídeos (enzimas modificadoras). Pensar por classe previne falhas terapêuticas."
      }
    },
    {
      title: "Marcadores de Resistência",
      content: `
        <div style="background: #eef2ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h3 style="color: #4338ca; margin-bottom: 15px;">🔬 Identificando Mecanismos Específicos</h3>
          <p style="font-size: 16px; line-height: 1.6; margin-bottom: 15px;">
            Verifique se há evidência de <strong>mecanismos específicos de resistência</strong> 
            (AmpC, ESBL ou carbapenemases) através de padrões característicos no antibiograma. 
            Identificar o mecanismo orienta a escolha terapêutica e medidas de controle de infecção.
          </p>
        </div>
        
        <div style="background: #dcfce7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #059669; margin-bottom: 15px;">🧬 AmpC β-Lactamase</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            <strong>AmpC</strong> é uma β-lactamase cromossômica ou plasmidial que confere 
            resistência a múltiplos β-lactâmicos, <strong>não inibida por clavulanato</strong>.
          </p>
          
          <div style="background: #f0fdf4; padding: 20px; border-radius: 8px; margin: 15px 0;">
            <h5 style="color: #166534; margin-bottom: 10px;">🦠 Espécies Suspeitas</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              Se o isolado é uma das seguintes espécies, <strong>já pense em AmpC</strong>:
            </p>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong><em>Enterobacter</em> spp.</strong> (E. cloacae, E. aerogenes)</li>
              <li><strong><em>Citrobacter freundii</em></strong></li>
              <li><strong><em>Serratia marcescens</em></strong></li>
              <li><strong><em>Morganella morganii</em></strong></li>
              <li><strong><em>Providencia</em> spp.</strong></li>
              <li><strong><em>Hafnia alvei</em></strong></li>
            </ul>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px; font-style: italic;">
              <strong>Mnemônico:</strong> "ESCPM" - <strong>E</strong>nterobacter, <strong>S</strong>erratia, 
              <strong>C</strong>itrobacter, <strong>P</strong>rovidencia, <strong>M</strong>organella
            </p>
          </div>
          
          <div style="background: #ecfdf5; padding: 20px; border-radius: 8px; margin: 15px 0;">
            <h5 style="color: #065f46; margin-bottom: 10px;">📋 Padrão de Sensibilidade Característico</h5>
            
            <div style="background: #fee2e2; padding: 15px; border-radius: 8px; margin: 10px 0;">
              <h6 style="color: #dc2626; margin-bottom: 10px;">❌ Resistente a:</h6>
              <ul style="margin-left: 20px; line-height: 1.8;">
                <li><strong>Amoxicilina/ácido clavulânico</strong> (clavulanato não inibe AmpC)</li>
                <li><strong>Cefalotina, cefuroxima</strong> (cefalosporinas de 1ª e 2ª geração)</li>
                <li><strong>Cefoxitina</strong> (importante marcador fenotípico)</li>
                <li><strong>Cefotaxima e/ou ceftazidima</strong> (pode haver resistência variável)</li>
                <li><strong>Piperacilina/tazobactam</strong> (muitas vezes reduzida)</li>
              </ul>
            </div>
            
            <div style="background: #dcfce7; padding: 15px; border-radius: 8px; margin: 10px 0;">
              <h6 style="color: #059669; margin-bottom: 10px;">✅ Sensível a:</h6>
              <ul style="margin-left: 20px; line-height: 1.8;">
                <li><strong>Cefepime</strong> (às vezes ainda ativo, pois é menos hidrolisado)</li>
                <li><strong>Carbapenêmicos</strong> (geralmente ativos, exceto se houver mecanismo adicional)</li>
              </ul>
            </div>
            
            <div style="background: #fef3c7; padding: 15px; border-radius: 8px; margin: 10px 0;">
              <h6 style="color: #d97706; margin-bottom: 10px;">⚠️ Marcador Chave</h6>
              <p style="font-size: 14px; line-height: 1.6; font-weight: bold;">
                <strong>Cefoxitina resistente + clavulanato sem restauração de sensibilidade 
                → sugere AmpC, não ESBL</strong>
              </p>
              <p style="font-size: 14px; line-height: 1.6; margin-top: 10px;">
                Diferente de ESBL, onde clavulanato restaura sensibilidade a cefalosporinas.
              </p>
            </div>
          </div>
          
          <div style="background: #fffbeb; padding: 20px; border-radius: 8px; margin: 15px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">🔍 Exemplo de Antibiograma com AmpC</h5>
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
              ...
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;">Cefalotina</td>
                <td style="padding: 8px; border: 1px solid #ddd;">> 64</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #dc2626; font-weight: bold;">R</td>
              </tr>
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Cefoxitina</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">> 32</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #dc2626; font-weight: bold;">R ⚠️</td>
              </tr>
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;">Ceftriaxona</td>
                <td style="padding: 8px; border: 1px solid #ddd;">16</td>
              ...
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;">Ceftazidima</td>
                <td style="padding: 8px; border: 1px solid #ddd;">8</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #d97706; font-weight: bold;">I</td>
              </tr>
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;">Cefepime</td>
                <td style="padding: 8px; border: 1px solid #ddd;">2</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #059669; font-weight: bold;">S</td>
              </tr>
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;">Piperacilina/tazobactam</td>
                <td style="padding: 8px; border: 1px solid #ddd;">32</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #d97706; font-weight: bold;">I</td>
              </tr>
              <tr style="background: #f9fafb;">
            ...
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px; font-weight: bold; color: #92400e;">
              <strong>Interpretação:</strong> Padrão típico de AmpC - resistência a cefoxitina, 
              cefalosporinas de 1ª-3ª geração, sem restauração por clavulanato, mas sensível a 
        ...
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #d97706; margin-bottom: 15px;">🧪 ESBL (Extended-Spectrum β-Lactamase)</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            Se um agente é <strong>resistente a todos os β-lactâmicos até cefalosporinas de 
            4ª geração</strong>, é possível que seja produtor de ESBL.
          </p>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">📋 Padrão Característico</h5>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li>❌ Resistente a cefalosporinas de 3ª geração (ceftriaxona, cefotaxima, ceftazidima)</li>
              <li>❌ Resistente a aztreonam</li>
              <li>✅ Sensível a carbapenêmicos (meropenem, imipenem)</li>
              <li>✅ Frequentemente sensível a piperacilina/tazobactam</li>
              <li>⚠️ Teste de sinergia com clavulanato positivo</li>
            </ul>
          </div>
        </div>
        
        <div style="background: #fee2e2; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #dc2626; margin-bottom: 15px;">🛡️ Carbapenemases (KPC, NDM, OXA-48)</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            Se <strong>resistente a todos os carbapenêmicos</strong>, é possível que seja um 
            produtor de carbapenemase.
          </p>
          
          <div style="background: #fef2f2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #991b1b; margin-bottom: 10px;">📋 Padrão Característico</h5>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li>❌ Resistente a meropenem, imipenem, ertapenem</li>
              <li>❌ Resistente a cefalosporinas de todas as gerações</li>
              <li>❌ Resistente a piperacilina/tazobactam</li>
              <li>⚠️ Pode ser sensível a ceftazidima/avibactam (se KPC)</li>
              <li>⚠️ Pode ser sensível a polimixinas e tigeciclina</li>
            </ul>
          </div>
        </div>
        ...
        <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; border-left: 4px solid #0ea5e9; margin: 15px 0;">
          <h4 style="color: #0369a1; margin-bottom: 10px;">💡 Mensagem Chave</h4>
          <p style="font-size: 14px; line-height: 1.6;">
            Identificar mecanismos de resistência através de padrões no antibiograma é fundamental 
            para escolha terapêutica adequada. <strong>AmpC:</strong> cefoxitina R + sem restauração 
            por clavulanato. <strong>ESBL:</strong> cefalosporinas 3ª geração R + carbapenêmicos S. 
            <strong>Carbapenemase:</strong> carbapenêmicos R.
          </p>
        </div>
      `,
      question: {
        text: "O que pode indicar a presença de uma β-lactamase do tipo AmpC em um antibiograma?",
        options: [
          "Resistência a amoxicilina/ácido clavulânico, cefalosporinas de primeira e segunda geração (como cefalotina e cefuroxima) e cefoxitina, sem restauração de sensibilidade pelo clavulanato, mantendo sensibilidade aos carbapenêmicos",
          "Resistência exclusiva aos carbapenêmicos, com sensibilidade preservada às cefalosporinas",
          "Sensibilidade total a todos os β-lactâmicos, incluindo cefalosporinas e penicilinas"
        ],
        correct: 0,
        explanation: "AmpC β-lactamase tem padrão característico: (1) Resistência a amoxicilina/clavulanato (clavulanato NÃO inibe AmpC); (2) Resistência a cefalosporinas de 1ª e 2ª geração e cefoxitina (marcador chave); (3) Resistência variável a cefalosporinas de 3ª geração; (4) Sensibilidade a cefepime e carbapenêmicos. Espécies suspeitas: Enterobacter, Serratia, Citrobacter, Providencia, Morganella (ESCPM). Diferente de ESBL onde clavulanato restaura sensibilidade. Diferente de carbapenemase onde há resistência a carbapenêmicos."
      }
    },
    {
      title: "Exemplo Prático I - ESBL",
      content: `
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h3 style="color: #d97706; margin-bottom: 15px;">🔬 Antibiograma com Produção de ESBL</h3>
          <p style="font-size: 16px; line-height: 1.6; margin-bottom: 15px;">
            <strong>ESBL (Extended-Spectrum β-Lactamase)</strong> é uma enzima que hidrolisa 
            cefalosporinas de espectro estendido e aztreonam, mas é <strong>inibida por clavulanato</strong> 
            e <strong>não hidrolisa carbapenêmicos</strong>.
          </p>
          
          <div style="background: #fffbeb; padding: 20px; border-radius: 8px; margin: 15px 0;">
            <h4 style="color: #92400e; margin-bottom: 15px;">📊 Caso Clínico</h4>
            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Paciente:</strong> Mulher, 65 anos, diabética<br>
              <strong>Quadro:</strong> Infecção do trato urinário complicada<br>
              <strong>Amostra:</strong> Urina (urocultura)<br>
              <strong>Microrganismo:</strong> <em>Escherichia coli</em> (> 100.000 UFC/mL)
            </p>
          </div>
        </div>
        
        <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #0369a1; margin-bottom: 15px;">📋 Resultado do Antibiograma</h4>
          
          <table style="width: 100%; border-collapse: collapse; margin: 15px 0; font-size: 14px;">
            <tr style="background: #0ea5e9; color: white;">
              <th style="padding: 12px; border: 1px solid #ddd;">Antibiótico</th>
              <th style="padding: 12px; border: 1px solid #ddd;">CIM (mg/L)</th>
              <th style="padding: 12px; border: 1px solid #ddd;">Resultado</th>
              <th style="padding: 12px; border: 1px solid #ddd;">Interpretação</th>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Amoxicilina</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">> 32</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Ceftriaxona</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">> 64</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (típico de ESBL)</td>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Cefotaxima</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">> 64</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (típico de ESBL)</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Ceftazidima</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">> 32</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (típico de ESBL)</td>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Aztreonam</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">> 32</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (típico de ESBL)</td>
            </tr>
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Piperacilina/Tazobactam</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">8</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #059669; font-weight: bold; font-size: 16px;">S</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Sensível (frequentemente ativo contra ESBL)</td>
            </tr>
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Imipenem</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">0,5</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #059669; font-weight: bold; font-size: 16px;">S</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Sensível (carbapenêmico, primeira escolha para ESBL)</td>
            </tr>
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Meropenem</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">≤ 0,25</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #059669; font-weight: bold; font-size: 16px;">S</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Sensível (carbapenêmico, primeira escolha para ESBL)</td>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Gentamicina</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">1</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #059669; font-weight: bold; font-size: 16px;">S</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Sensível</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Ciprofloxacino</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">4</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (comum em ESBL)</td>
            </tr>
          </table>
        </div>
        
        <div style="background: #fee2e2; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #dc2626; margin-bottom: 15px;">🔍 Análise do Padrão</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            Este perfil, com <strong>resistência a múltiplas cefalosporinas de espectro estendido 
            e aztreonam</strong>, mas <strong>sensibilidade a carbapenêmicos</strong> e frequentemente 
            a inibidores de β-lactamase, é <strong>altamente indicativo de produção de ESBL</strong>.
          </p>
          
          <div style="background: #fef2f2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #991b1b; margin-bottom: 10px;">🎯 Características Chave da ESBL</h5>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li>✅ <strong>Resistência a cefalosporinas de 3ª geração:</strong> Ceftriaxona, cefotaxima, ceftazidima</li>
              <li>✅ <strong>Resistência a aztreonam:</strong> Monobactâmico também é hidrolisado</li>
              <li>✅ <strong>Sensibilidade a carbapenêmicos:</strong> ESBL não hidrolisa carbapenêmicos</li>
              <li>✅ <strong>Sensibilidade a inibidores de β-lactamase:</strong> Piperacilina/tazobactam frequentemente ativo</li>
              <li>⚠️ <strong>Frequente resistência a quinolonas:</strong> Genes de ESBL e resistência a quinolonas em plasmídeos</li>
            </ul>
          </div>
        </div>
        
        <div style="background: #dcfce7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #059669; margin-bottom: 15px;">💊 Implicações Terapêuticas</h4>
          
          <div style="background: #f0fdf4; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #166534; margin-bottom: 10px;">✅ Opções Terapêuticas</h5>
            <ol style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Carbapenêmicos (primeira escolha):</strong> Meropenem, imipenem, ertapenem</li>
              <li><strong>Piperacilina/tazobactam:</strong> Alternativa em infecções não graves</li>
              <li><strong>Aminoglicosídeos:</strong> Gentamicina, amicacina (em combinação)</li>
              <li><strong>Ceftazidima/avibactam:</strong> Nova opção, avibactam inibe ESBL</li>
            </ol>
          </div>
          
          <div style="background: #fee2e2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #dc2626; margin-bottom: 10px;">❌ Evitar</h5>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Cefalosporinas de 3ª geração:</strong> Mesmo se "S" in vitro, alto risco de falha</li>
              <li><strong>Aztreonam:</strong> Resistente</li>
              <li><strong>Quinolonas:</strong> Frequentemente co-resistentes</li>
            </ul>
          </div>
          
          <div style="background: #dbeafe; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #1e40af; margin-bottom: 10px;">🏥 Decisão Terapêutica para Este Caso</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>ITU complicada por <em>E. coli</em> ESBL em paciente diabética:</strong>
            </p>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Opção 1 (preferencial):</strong> Ertapenem 1g IV 24/24h por 7-10 dias</li>
              <li><strong>Opção 2:</strong> Piperacilina/tazobactam 4,5g IV 6/6h por 7-10 dias</li>
              <li><strong>Opção 3:</strong> Meropenem 1g IV 8/8h (se sepse ou pielonefrite grave)</li>
            </ul>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px; font-style: italic;">
              <strong>Nota:</strong> Evitar ceftriaxona mesmo se reportada como "S" - alto risco de falha terapêutica.
            </p>
          </div>
        </div>
        
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #d97706; margin-bottom: 15px;">🦠 Controle de Infecção</h4>
          <ul style="margin-left: 20px; line-height: 1.8;">
            <li><strong>Precauções de contato:</strong> Luvas e avental para contato com paciente</li>
            <li><strong>Quarto privativo:</strong> Quando possível</li>
            <li><strong>Higiene das mãos:</strong> Rigorosa antes e após contato</li>
            <li><strong>Notificação:</strong> Informar equipe de controle de infecção</li>
            <li><strong>Vigilância:</strong> Rastreamento de colonização em contatos</li>
          </ul>
        </div>
        ...
        <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; border-left: 4px solid #0ea5e9; margin: 15px 0;">
          <h4 style="color: #0369a1; margin-bottom: 10px;">💡 Mensagem Chave</h4>
          <p style="font-size: 14px; line-height: 1.6;">
            <strong>Padrão ESBL:</strong> Resistência a cefalosporinas de 3ª geração + aztreonam, 
            sensibilidade a carbapenêmicos e piperacilina/tazobactam. Carbapenêmicos são primeira 
            escolha. Implementar precauções de contato. Evitar cefalosporinas mesmo se "S" in vitro.
          </p>
        </div>
      `,
      question: {
        text: "Qual padrão de sensibilidade em um antibiograma sugere fortemente a produção de ESBL (β-lactamase de espectro estendido)?",
        options: [
          "Resistência a múltiplas cefalosporinas de espectro estendido e ao aztreonam, com sensibilidade preservada a carbapenêmicos e, por vezes, ao piperacilina/tazobactam",
          "Sensibilidade a todas as cefalosporinas e resistência apenas ao imipenem e meropenem",
          "Resistência apenas à amoxicilina, mantendo sensibilidade a todas as demais classes de β-lactâmicos"
        ],
        correct: 0,
        explanation: "ESBL (Extended-Spectrum β-Lactamase) tem padrão característico: (1) Resistência a cefalosporinas de 3ª geração (ceftriaxona, cefotaxima, ceftazidima); (2) Resistência a aztreonam; (3) Sensibilidade a carbapenêmicos (ESBL não hidrolisa carbapenêmicos); (4) Frequentemente sensível a piperacilina/tazobactam (tazobactam inibe ESBL); (5) Comum co-resistência a quinolonas. Tratamento: carbapenêmicos são primeira escolha. Evitar cefalosporinas mesmo se 'S' in vitro. Implementar precauções de contato."
      }
    },
    {
      title: "Exemplo Prático II - Resistência a Quinolonas",
      content: `
        <div style="background: #fee2e2; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h3 style="color: #dc2626; margin-bottom: 15px;">⚠️ Antibiograma com Possível Resistência a Quinolonas</h3>
          <p style="font-size: 16px; line-height: 1.6; margin-bottom: 15px;">
            Este exemplo ilustra um perfil de resistência que sugere a presença de <strong>resistência 
            específica a quinolonas</strong>. Nele, observa-se <strong>resistência a ácido nalidíxico</strong> 
            enquanto cefuroxima, ciprofloxacina, aminoglicosídeos e carbapenêmicos permanecem sensíveis.
          </p>
          
          <div style="background: #fef2f2; padding: 20px; border-radius: 8px; margin: 15px 0;">
            <h4 style="color: #991b1b; margin-bottom: 15px;">📊 Caso Clínico</h4>
            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Paciente:</strong> Homem, 58 anos, hipertenso<br>
              <strong>Quadro:</strong> Infecção do trato urinário recorrente<br>
              <strong>Amostra:</strong> Urina (urocultura)<br>
              <strong>Microrganismo:</strong> <em>Escherichia coli</em> (> 100.000 UFC/mL)<br>
              <strong>História:</strong> Uso prévio de ciprofloxacino há 3 meses
            </p>
          </div>
        </div>
        ...
        <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin: 15px 0; font-size: 14px;">
            ...
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Cefuroxima</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">4</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #059669; font-weight: bold; font-size: 16px;">S</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Sensível</td>
            </tr>
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Ciprofloxacina</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">1</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #059669; font-weight: bold; font-size: 16px;">S</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Sensível (mas CIM próxima ao ponto de corte)</td>
            </tr>
            <tr style="background: #fee2e2;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Ác. Nalidíxico</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">> 256</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R ⚠️</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (marcador de mutação em gyrA)</td>
            </tr>
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Gentamicina</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">1</td>
            ...
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Amicacina</strong></td>
            ...
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Nitrofurantoína</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">16</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #059669; font-weight: bold; font-size: 16px;">S</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Sensível</td>
            </tr>
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Sulfametoxazol/trimetoprima</strong></td>
        ...
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #d97706; margin-bottom: 15px;">🔍 Análise do Padrão</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            Este perfil, com <strong>resistência a ácido nalidíxico</strong>, pode sugerir 
            <strong>possível resistência a demais quinolonas</strong>. Talvez seja prudente 
            <strong>evitar essa classe</strong>.
          </p>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">🧬 O Que É Ácido Nalidíxico?</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Ácido nalidíxico</strong> é uma quinolona de <strong>primeira geração</strong>, 
              raramente usada clinicamente hoje, mas <strong>extremamente útil como marcador</strong> 
              de resistência a quinolonas.
            </p>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Marcador sensível:</strong> Detecta mutações em gyrA antes que CIM de quinolonas modernas suba</li>
              <li><strong>Preditor de falha:</strong> Resistência indica alto risco de falha com quinolonas</li>
              <li><strong>Seleção de resistência:</strong> Uso de quinolonas pode selecionar mutações adicionais</li>
            </ul>
          </div>
          
          <div style="background: #fee2e2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #dc2626; margin-bottom: 10px;">⚠️ Por Que Evitar Quinolonas Mesmo com "S"?</h5>
            <ol style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Mutação em gyrA já presente:</strong> Resistência ao ácido nalidíxico indica mutação</li>
              <li><strong>CIM próxima ao ponto de corte:</strong> Ciprofloxacino CIM = 1 mg/L (ponto de corte S ≤ 1)</li>
              <li><strong>Risco de seleção de resistência:</strong> Durante tratamento, mutações adicionais podem surgir</li>
              <li><strong>Falha terapêutica documentada:</strong> Estudos mostram maior taxa de falha nesse cenário</li>
              <li><strong>Alternativas disponíveis:</strong> Outras classes eficazes e seguras</li>
            </ol>
          </div>
        </div>
        ...
        <div style="background: #dcfce7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          ...
          <div style="background: #f0fdf4; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #166534; margin-bottom: 10px;">✅ Opções Terapêuticas Recomendadas</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              Para ITU não complicada por <em>E. coli</em> com resistência a ácido nalidíxico:
            </p>
            <ol style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Nitrofurantoína 100mg VO 6/6h por 5-7 dias</strong> (primeira escolha para cistite)</li>
              <li><strong>Sulfametoxazol/trimetoprima 800/160mg VO 12/12h por 3 dias</strong></li>
              <li><strong>Cefuroxima 500mg VO 12/12h por 5-7 dias</strong></li>
              <li><strong>Fosfomicina 3g VO dose única</strong> (se disponível)</li>
            </ol>
          </div>
          ...
          <div style="background: #fee2e2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #dc2626; margin-bottom: 10px;">❌ Evitar</h5>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Ciprofloxacino:</strong> Mesmo "S", alto risco de falha</li>
              <li><strong>Levofloxacino:</strong> Mesmo "S", alto risco de falha</li>
              <li><strong>Norfloxacino:</strong> Mesmo "S", alto risco de falha</li>
              <li><strong>Qualquer quinolona:</strong> Resistência cruzada provável</li>
            </ul>
          </div>
          ...
          <div style="background: #dbeafe; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #1e40af; margin-bottom: 10px;">🏥 Decisão Terapêutica para Este Caso</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>ITU recorrente por <em>E. coli</em> com resistência a ácido nalidíxico:</strong>
            </p>
            <p style="font-size: 14px; line-height: 1.6; font-weight: bold; color: #1e40af;">
              <strong>Prescrição:</strong> Nitrofurantoína 100mg VO 6/6h por 7 dias
            </p>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px;">
              <strong>Justificativa:</strong>
            </p>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li>Excelente atividade contra <em>E. coli</em></li>
              <li>Alta concentração urinária</li>
              <li>Evita quinolonas (risco de falha)</li>
              <li>Baixo risco de seleção de resistência</li>
        ...
        <div style="background: #eef2ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #4338ca; margin-bottom: 15px;">📚 Conceitos Importantes</h4>
          
          <div style="background: #dbeafe; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #1e40af; margin-bottom: 10px;">🔬 Mecanismo de Resistência a Quinolonas</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              Resistência a quinolonas ocorre por <strong>mutações sequenciais</strong>:
            </p>
            <ol style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Primeira mutação (gyrA):</strong> Resistência a ácido nalidíxico, CIM de quinolonas modernas sobe</li>
              <li><strong>Segunda mutação (parC):</strong> Resistência de alto nível a todas as quinolonas</li>
              <li><strong>Bombas de efluxo:</strong> Expulsão ativa de quinolonas</li>
              <li><strong>Alteração de permeabilidade:</strong> Redução de entrada</li>
            </ol>
          </div>
          
          <div style="background: #fef3c7; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #d97706; margin-bottom: 10px;">⚠️ Seleção de Resistência Durante Tratamento</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              Usar quinolona em bactéria com mutação em gyrA pode selecionar mutação adicional em parC:
            </p>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Antes do tratamento:</strong> 1 mutação (gyrA) → CIM = 1 mg/L (S)</li>
              <li><strong>Durante tratamento:</strong> Pressão seletiva → 2 mutações (gyrA + parC)</li>
              <li><strong>Após tratamento:</strong> CIM > 4 mg/L (R) → Falha terapêutica</li>
            </ul>
          </div>
        </div>
        ...
        <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; border-left: 4px solid #0ea5e9; margin: 15px 0;">
          <h4 style="color: #0369a1; margin-bottom: 10px;">💡 Mensagem Chave</h4>
          <p style="font-size: 14px; line-height: 1.6;">
            <strong>Resistência ao ácido nalidíxico é marcador de mutação em gyrA</strong>, indicando 
            que quinolonas podem falhar mesmo se reportadas como "S". CIM próxima ao ponto de corte 
            aumenta risco de seleção de resistência durante tratamento. <strong>Recomendação: evitar 
            quinolonas</strong> e usar alternativas (nitrofurantoína, sulfametoxazol/trimetoprima, 
            cefalosporinas).
          </p>
        </div>
      `,
      question: {
        text: "Um laboratório apresenta o seguinte perfil de resistência de uma bactéria: resistência ao ácido nalidíxico e sensibilidade à cefuroxima, ciprofloxacina, aminoglicosídeos e carbapenêmicos. Qual das seguintes afirmações é mais correta?",
        options: [
          "O paciente pode ser tratado com qualquer quinolona sem preocupação, pois a ciprofloxacina ainda é sensível",
          "A resistência ao ácido nalidíxico sugere que pode haver resistência a outras quinolonas, sendo prudente evitar essa classe",
          "A bactéria apresenta resistência apenas aos carbapenêmicos e deve-se evitar essa classe de antibióticos"
        ],
        correct: 1,
        explanation: "Resistência ao ácido nalidíxico é marcador de mutação em gyrA, indicando resistência emergente a quinolonas. Mesmo com ciprofloxacino 'S', há alto risco de falha porque: (1) CIM está próxima ao ponto de corte; (2) Mutação em gyrA já presente; (3) Uso de quinolona pode selecionar mutação adicional em parC durante tratamento; (4) Estudos mostram maior taxa de falha nesse cenário. Recomendação: evitar quinolonas e usar alternativas (nitrofurantoína, sulfametoxazol/trimetoprima, cefalosporinas). Ácido nalidíxico é quinolona de 1ª geração usada como marcador, não para tratamento."
      }
    },
    {
      title: "Exemplo Prático III - AmpC em Enterobacter",
      content: `
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h3 style="color: #d97706; margin-bottom: 15px;">🦠 Antibiograma com Produção de AmpC</h3>
          <p style="font-size: 16px; line-height: 1.6; margin-bottom: 15px;">
            <strong>AmpC β-lactamase</strong> é uma enzima cromossômica ou plasmidial que confere 
            resistência a múltiplos β-lactâmicos, <strong>não inibida por clavulanato</strong>. 
            É especialmente importante em espécies do grupo <strong>ESCPM</strong>.
          </p>
          
          <div style="background: #fffbeb; padding: 20px; border-radius: 8px; margin: 15px 0;">
            <h4 style="color: #92400e; margin-bottom: 15px;">📊 Caso Clínico</h4>
            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Paciente:</strong> Mulher, 72 anos, internada em UTI<br>
              <strong>Quadro:</strong> Pneumonia associada à ventilação mecânica (PAV)<br>
              <strong>Amostra:</strong> Aspirado traqueal<br>
              <strong>Microrganismo:</strong> <em>Enterobacter cloacae</em> (cultura quantitativa > 10⁶ UFC/mL)<br>
              <strong>História:</strong> Uso prévio de ceftriaxona por 5 dias
            </p>
          </div>
        </div>
        ...
        <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin: 15px 0; font-size: 14px;">
            ...
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Ampicilina</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">> 32</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (intrínseco em <em>Enterobacter</em>)</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Amoxicilina/clavulanato</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">> 32</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (clavulanato não inibe AmpC)</td>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Cefalotina</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">> 64</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (cefalosporina de 1ª geração)</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Cefuroxima</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">> 64</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (cefalosporina de 2ª geração)</td>
            </tr>
            <tr style="background: #fee2e2;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Cefoxitina</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">> 32</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R ⚠️</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (marcador fenotípico de AmpC)</td>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Ceftriaxona</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">32</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #dc2626; font-weight: bold; font-size: 16px;">R</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Resistente (cefalosporina de 3ª geração)</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Ceftazidima</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">16</td>
            ...
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Cefepime</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">2</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #059669; font-weight: bold; font-size: 16px;">S</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Sensível (menos hidrolisado por AmpC)</td>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Piperacilina/tazobactam</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">64</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #d97706; font-weight: bold; font-size: 16px;">I</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Intermediário (tazobactam não inibe AmpC)</td>
            </tr>
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Imipenem</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">1</td>
              <td style="padding: 10px; border: 1px solid #ddd; color: #059669; font-weight: bold; font-size: 16px;">S</td>
              <td style="padding: 10px; border: 1px solid #ddd;">Sensível (carbapenêmico)</td>
            </tr>
            <tr style="background: #dcfce7;">
              <td style="padding: 10px; border: 1px solid #ddd;"><strong>Meropenem</strong></td>
              <td style="padding: 10px; border: 1px solid #ddd;">0,5</td>
        ...
        <div style="background: #fee2e2; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #dc2626; margin-bottom: 15px;">🔍 Análise do Padrão - Atenção para AmpC!</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            Este antibiograma apresenta <strong>padrão típico de produção de AmpC</strong> em 
            <em>Enterobacter cloacae</em>, uma espécie do grupo ESCPM.
          </p>
          
          <div style="background: #fef2f2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #991b1b; margin-bottom: 10px;">🎯 Marcadores de AmpC Presentes</h5>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li>✅ <strong>Espécie do grupo ESCPM:</strong> <em>Enterobacter cloacae</em></li>
              <li>✅ <strong>Resistência a cefoxitina:</strong> Marcador fenotípico chave</li>
              <li>✅ <strong>Resistência a cefalosporinas de 1ª-3ª geração:</strong> Cefalotina, cefuroxima, ceftriaxona, ceftazidima</li>
              <li>✅ <strong>Resistência a amoxicilina/clavulanato:</strong> Clavulanato não inibe AmpC</li>
              <li>✅ <strong>Sensibilidade a cefepime:</strong> Menos hidrolisado por AmpC</li>
              <li>✅ <strong>Sensibilidade a carbapenêmicos:</strong> AmpC não hidrolisa carbapenêmicos</li>
            </ul>
          </div>
          
          <div style="background: #fef3c7; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #d97706; margin-bottom: 10px;">⚠️ Diferenciando AmpC de ESBL</h5>
            
            <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
              <tr style="background: #f59e0b; color: white;">
                <th style="padding: 10px; border: 1px solid #ddd;">Característica</th>
                <th style="padding: 10px; border: 1px solid #ddd;">AmpC</th>
                <th style="padding: 10px; border: 1px solid #ddd;">ESBL</th>
              </tr>
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Cefoxitina</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd; background: #fee2e2;">R (marcador)</td>
                <td style="padding: 8px; border: 1px solid #ddd; background: #dcfce7;">S</td>
              </tr>
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Clavulanato</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">Não inibe</td>
                <td style="padding: 8px; border: 1px solid #ddd;">Inibe (restaura sensibilidade)</td>
              </tr>
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Cefepime</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">Frequentemente S</td>
                <td style="padding: 8px; border: 1px solid #ddd;">Variável (pode ser R)</td>
              </tr>
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Carbapenêmicos</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">S</td>
                <td style="padding: 8px; border: 1px solid #ddd;">S</td>
              </tr>
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Espécies típicas</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">ESCPM</td>
                <td style="padding: 8px; border: 1px solid #ddd;"><em>E. coli</em>, <em>Klebsiella</em></td>
              </tr>
            </table>
          </div>
        </div>
        ...
        <div style="background: #dcfce7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          ...
          <div style="background: #f0fdf4; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #166534; margin-bottom: 10px;">✅ Opções Terapêuticas</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              Para PAV por <em>Enterobacter cloacae</em> produtor de AmpC:
            </p>
            <ol style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Meropenem 1-2g IV 8/8h</strong> (primeira escolha)</li>
              <li><strong>Cefepime 2g IV 8/8h</strong> (alternativa, mas monitorar resposta)</li>
              <li><strong>Ciprofloxacino 400mg IV 8/8h</strong> (se sensível, em combinação)</li>
              <li><strong>Aminoglicosídeo</strong> (gentamicina ou amicacina) em combinação</li>
            </ol>
          </div>
          ...
          <div style="background: #fee2e2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #dc2626; margin-bottom: 10px;">❌ Evitar</h5>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Ceftriaxona:</strong> Resistente, foi o que selecionou AmpC</li>
              <li><strong>Ceftazidima:</strong> Resistente</li>
              <li><strong>Piperacilina/tazobactam:</strong> Intermediário, tazobactam não inibe AmpC</li>
              <li><strong>Amoxicilina/clavulanato:</strong> Resistente, clavulanato não inibe AmpC</li>
            </ul>
          </div>
          ...
          <div style="background: #dbeafe; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #1e40af; margin-bottom: 10px;">🏥 Decisão Terapêutica para Este Caso</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>PAV por <em>Enterobacter cloacae</em> AmpC em paciente de UTI:</strong>
            </p>
            <p style="font-size: 14px; line-height: 1.6; font-weight: bold; color: #1e40af;">
              <strong>Prescrição:</strong> Meropenem 2g IV 8/8h em infusão prolongada (3h) + Amicacina 15-20 mg/kg/dia IV dose única
            </p>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px;">
              <strong>Justificativa:</strong>
            </p>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li>Meropenem: Carbapenêmico de escolha para AmpC</li>
              <li>Infusão prolongada: Otimização PK/PD (T > CIM)</li>
              <li>Amicacina: Sinergia, prevenir resistência</li>
              <li>Dose única de aminoglicosídeo: Reduz nefrotoxicidade</li>
              <li>Duração: 7-10 dias (reavaliação em 72h)</li>
            </ul>
          </div>
        </div>
        
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #d97706; margin-bottom: 15px;">⚠️ Risco de Seleção de AmpC</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            <strong>Uso de cefalosporinas de 3ª geração</strong> (como ceftriaxona) em espécies 
            do grupo ESCPM pode <strong>selecionar mutantes hiperexpressores de AmpC</strong> 
            durante o tratamento.
          </p>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">🧬 Mecanismo de Seleção</h5>
            <ol style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Baseline:</strong> AmpC cromossômica em baixa expressão (sensível a ceftriaxona)</li>
              <li><strong>Exposição a ceftriaxona:</strong> Pressão seletiva favorece mutantes</li>
              <li><strong>Mutação em ampD:</strong> Desrepressão → hiperexpressão de AmpC</li>
              <li><strong>Resultado:</strong> Resistência a todas as cefalosporinas (exceto cefepime)</li>
              <li><strong>Falha terapêutica:</strong> Paciente piora apesar de "S" inicial</li>
            </ol>
          </div>
          
          <div style="background: #fee2e2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #dc2626; margin-bottom: 10px;">📋 Caso Clínico Ilustrativo</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Dia 1:</strong> Hemocultura positiva para <em>Enterobacter cloacae</em>, sensível a ceftriaxona<br>
              <strong>Dia 1-5:</strong> Tratamento com ceftriaxona 2g IV 24/24h<br>
              <strong>Dia 6:</strong> Piora clínica, nova hemocultura positiva<br>
              <strong>Dia 6:</strong> Antibiograma mostra resistência a ceftriaxona (seleção de AmpC)<br>
              <strong>Resultado:</strong> Falha terapêutica, necessidade de carbapenêmico
            </p>
          </div>
        </div>
        
        <div style="background: #eef2ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #4338ca; margin-bottom: 15px;">📚 Recomendações para Espécies ESCPM</h4>
          <ol style="margin-left: 20px; line-height: 1.8;">
            <li><strong>Evitar cefalosporinas de 3ª geração:</strong> Alto risco de seleção de AmpC</li>
            <li><strong>Preferir carbapenêmicos:</strong> Meropenem, imipenem (primeira escolha)</li>
            <li><strong>Cefepime pode ser usado:</strong> Mas monitorar resposta clínica</li>
            <li><strong>Considerar combinação:</strong> β-lactâmico + aminoglicosídeo ou fluoroquinolona</li>
            <li><strong>Monitorar resposta:</strong> Reavaliação em 48-72h</li>
          </ol>
        </div>
        ...
        <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; border-left: 4px solid #0ea5e9; margin: 15px 0;">
          <h4 style="color: #0369a1; margin-bottom: 10px;">💡 Mensagem Chave</h4>
          <p style="font-size: 14px; line-height: 1.6;">
            <strong>Espécies ESCPM</strong> (<em>Enterobacter</em>, <em>Serratia</em>, <em>Citrobacter</em>, 
            <em>Providencia</em>, <em>Morganella</em>) possuem AmpC cromossômica. <strong>Padrão AmpC:</strong> 
            resistência a cefoxitina + cefalosporinas de 1ª-3ª geração, sem restauração por clavulanato, 
            sensível a cefepime e carbapenêmicos. <strong>Risco:</strong> Uso de cefalosporinas de 3ª 
            geração pode selecionar hiperexpressão de AmpC. <strong>Tratamento:</strong> Carbapenêmicos 
            são primeira escolha.
          </p>
        </div>
      `,
      question: {
        text: "Um antibiograma de Enterobacter cloacae isolado de aspirado traqueal mostra resistência a amoxicilina/clavulanato, cefalotina, cefuroxima, cefoxitina, ceftriaxona e ceftazidima, mas sensibilidade a cefepime, meropenem e gentamicina. Qual é a interpretação mais provável?",
        options: [
          "Produção de ESBL, pois há resistência a cefalosporinas de 3ª geração",
          "Produção de AmpC β-lactamase, indicada pela resistência a cefoxitina sem restauração por clavulanato e sensibilidade a cefepime e carbapenêmicos",
          "Produção de carbapenemase, pois há resistência a múltiplos β-lactâmicos"
        ],
        correct: 1,
        explanation: "Este é padrão típico de AmpC em Enterobacter (espécie ESCPM): (1) Resistência a cefoxitina (marcador chave); (2) Resistência a cefalosporinas de 1ª-3ª geração; (3) Resistência a amoxicilina/clavulanato (clavulanato NÃO inibe AmpC); (4) Sensibilidade a cefepime (menos hidrolisado); (5) Sensibilidade a carbapenêmicos (AmpC não hidrolisa). Diferente de ESBL onde clavulanato restaura sensibilidade. Diferente de carbapenemase onde há resistência a carbapenêmicos. Tratamento: carbapenêmicos primeira escolha. Evitar cefalosporinas de 3ª geração (risco de seleção de hiperexpressão de AmpC)."
      }
    }
          ]
        },
  ...
  sections: [
    {
      ...
      content: `
        <div style="background: #fee2e2; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h3 style="color: #dc2626; margin-bottom: 15px;">❌ Erro Crítico: Comparar CIMs de Diferentes Antibióticos</h3>
          <p style="font-size: 16px; line-height: 1.6; margin-bottom: 15px;">
            <strong>Não se compara CIMs de diferentes antibióticos</strong> em relação a uma mesma bactéria, 
            pois cada classe tem <strong>características farmacocinéticas e farmacodinâmicas próprias</strong>.
          </p>
          
          <div style="background: #fef2f2; padding: 15px; border-radius: 8px; margin: 15px 0;">
            <h4 style="color: #991b1b; margin-bottom: 10px;">⚠️ Por Que É Um Erro?</h4>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              CIM é uma medida <strong>in vitro</strong> que não leva em conta:
            </p>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Farmacocinética:</strong> Absorção, distribuição, metabolismo, excreção</li>
              <li><strong>Farmacodinâmica:</strong> Tempo-dependente vs. concentração-dependente</li>
              <li><strong>Penetração tecidual:</strong> Concentração no sítio de infecção</li>
              <li><strong>Ligação proteica:</strong> Fração livre disponível</li>
              <li><strong>Efeito pós-antibiótico:</strong> Atividade após exposição</li>
            </ul>
          </div>
        </div>
        
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #d97706; margin-bottom: 15px;">🏃 Analogia: Qual o Melhor Atleta?</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            <strong>O que chega em 02 min ou o que chega em 01:45h?</strong>
          </p>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            Isso vai depender de <strong>qual prova cada um está concorrendo</strong>:
          </p>
          <ul style="margin-left: 20px; line-height: 1.8;">
            <li>Se o primeiro estiver numa <strong>corrida de 100m</strong> → 02 min é péssimo</li>
            <li>Se o segundo estiver numa <strong>maratona</strong> → 01:45h é excelente</li>
          </ul>
          <p style="font-size: 15px; line-height: 1.6; margin-top: 15px; font-weight: bold; color: #92400e;">
            Pode ser que o segundo atleta seja melhor apesar do tempo maior, pois estão em provas diferentes!
          </p>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 15px 0;">
            <h5 style="color: #78350f; margin-bottom: 10px;">🔬 Aplicando ao Antibiograma</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              A mesma lógica se aplica à <strong>CIM de cada antibiótico para cada bactéria</strong>:
            </p>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li>Cada antibiótico tem seu "tipo de prova" (mecanismo de ação, PK/PD)</li>
              <li>A CIM é <strong>única</strong> para aquele antibiótico e aquela bactéria</li>
              <li><strong>Não pode ser comparada</strong> com CIMs de outros antibióticos</li>
            </ul>
          </div>
        </div>
        
        <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #0369a1; margin-bottom: 15px;">📊 Exemplo Prático: Comparação Inadequada</h4>
          
          <div style="background: #dbeafe; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #1e40af; margin-bottom: 10px;">🦠 Caso Clínico</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Paciente:</strong> Homem, 45 anos<br>
              <strong>Diagnóstico:</strong> Pneumonia por <em>Streptococcus pneumoniae</em><br>
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
              ...
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;">Penicilina G</td>
                <td style="padding: 8px; border: 1px solid #ddd;">0,06</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #059669; font-weight: bold;">S</td>
              </tr>
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;">Ceftriaxona</td>
              ...
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;">Levofloxacino</td>
                <td style="padding: 8px; border: 1px solid #ddd;">1</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #059669; font-weight: bold;">S</td>
              </tr>
            </table>
          ...
          <div style="background: #fee2e2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #dc2626; margin-bottom: 10px;">❌ Raciocínio Incorreto</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>"Penicilina G tem CIM menor (0,06), então é melhor que levofloxacino (CIM 1)!"</strong>
            </p>
            <p style="font-size: 14px; line-height: 1.6; font-weight: bold; color: #991b1b;">
              ⚠️ <strong>ERRO!</strong> Não se pode comparar CIMs de antibióticos diferentes!
            </p>
          </div>
          
          <div style="background: #dcfce7; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #059669; margin-bottom: 10px;">✅ Raciocínio Correto</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Todos são "S" (sensíveis), então todos podem ser usados.</strong> A escolha deve considerar:
            </p>
            <ol style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Espectro:</strong> Penicilina G é mais estreita (preserva microbiota)</li>
              <li><strong>Via de administração:</strong> Penicilina G é IV, levofloxacino pode ser VO</li>
              <li><strong>Custo:</strong> Penicilina G é mais barata</li>
              <li><strong>Efeitos adversos:</strong> Quinolonas têm mais efeitos adversos</li>
              <li><strong>Contexto clínico:</strong> Gravidade, alergias, comorbidades</li>
            </ol>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px; font-weight: bold; color: #166534;">
              <strong>Decisão:</strong> Penicilina G é primeira escolha para pneumonia pneumocócica sensível!
            </p>
          </div>
        </div>
        
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #d97706; margin-bottom: 15px;">🔬 Por Que as CIMs São Diferentes?</h4>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">1. Mecanismo de Ação Diferente</h5>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Penicilina G:</strong> Inibe síntese de parede celular (PBPs)</li>
              <li><strong>Levofloxacino:</strong> Inibe DNA girase e topoisomerase IV</li>
              <li><strong>Vancomicina:</strong> Inibe síntese de parede (D-Ala-D-Ala)</li>
            </ul>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px;">
              → Cada um tem afinidade diferente pelo alvo bacteriano
            </p>
          </div>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">2. Farmacocinética Diferente</h5>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Penicilina G:</strong> Meia-vida curta (30 min), T > CIM</li>
              <li><strong>Levofloxacino:</strong> Meia-vida longa (6-8h), AUC/CIM</li>
              <li><strong>Vancomicina:</strong> Meia-vida longa (4-6h), AUC/CIM</li>
            </ul>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px;">
              → Concentração no sítio de infecção varia ao longo do tempo
            </p>
          </div>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">3. Farmacodinâmica Diferente</h5>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Penicilina G:</strong> Tempo-dependente (T > CIM > 40-50%)</li>
              <li><strong>Levofloxacino:</strong> Concentração-dependente (AUC/CIM > 30)</li>
              <li><strong>Vancomicina:</strong> Concentração-dependente (AUC/CIM > 400)</li>
            </ul>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px;">
              → Eficácia depende de parâmetros PK/PD diferentes
            </p>
          </div>
        </div>
        
        <div style="background: #dcfce7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #059669; margin-bottom: 15px;">✅ Como Interpretar Corretamente?</h4>
          <ol style="margin-left: 20px; line-height: 1.8;">
            <li><strong>Use a interpretação S/I/R:</strong> Não compare CIMs numéricas</li>
            <li><strong>Considere o contexto clínico:</strong> Gravidade, sítio de infecção, paciente</li>
            <li><strong>Avalie espectro:</strong> Prefira antibiótico mais estreito</li>
            <li><strong>Considere PK/PD:</strong> Penetração tecidual, dose, intervalo</li>
            <li><strong>Avalie custo e disponibilidade:</strong> Recursos limitados</li>
            <li><strong>Considere efeitos adversos:</strong> Segurança do paciente</li>
          </ol>
        </div>
        
        <div style="background: #eef2ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #4338ca; margin-bottom: 15px;">📚 Exceção: Quando Comparar CIMs?</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            <strong>Única situação válida:</strong> Comparar CIMs do <strong>mesmo antibiótico</strong> 
            em <strong>diferentes isolados</strong> ou ao longo do tempo.
          </p>
          
          <div style="background: #dbeafe; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #1e40af; margin-bottom: 10px;">✅ Exemplo Válido</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Monitoramento de resistência em <em>S. aureus</em> ao longo do tempo:</strong>
            </p>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>2020:</strong> Vancomicina CIM = 0,5 mg/L (S)</li>
              <li><strong>2021:</strong> Vancomicina CIM = 1 mg/L (S)</li>
              <li><strong>2022:</strong> Vancomicina CIM = 2 mg/L (S, mas "creep")</li>
            </ul>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px; font-weight: bold; color: #1e40af;">
              → Aumento progressivo da CIM (MIC creep) pode indicar resistência emergente
            </p>
          </div>
        </div>
        ...
        <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; border-left: 4px solid #0ea5e9; margin: 15px 0;">
          <h4 style="color: #0369a1; margin-bottom: 10px;">💡 Mensagem Chave</h4>
          <p style="font-size: 14px; line-height: 1.6;">
            <strong>Não compare CIMs de diferentes antibióticos!</strong> Cada antibiótico tem PK/PD 
            própria, mecanismo de ação único e penetração tecidual específica. Use a interpretação 
            S/I/R e considere contexto clínico, espectro, custo e segurança. CIM menor ≠ antibiótico melhor.
          </p>
        </div>
      `,
      question: {
        text: "Por que não se deve comparar CIMs (concentração inibitória mínima) de diferentes antibióticos para uma mesma bactéria?",
        options: [
          "Porque cada antibiótico tem características farmacocinéticas e farmacodinâmicas próprias, tornando a comparação inadequada",
          "Porque todos os antibióticos têm a mesma eficácia, independentemente da CIM",
          "Porque a CIM indica apenas a toxicidade do antibiótico, não sua atividade contra a bactéria"
        ],
        correct: 0,
        explanation: "Não se deve comparar CIMs de diferentes antibióticos porque cada um tem: (1) Mecanismo de ação diferente (afinidade pelo alvo); (2) Farmacocinética diferente (absorção, distribuição, meia-vida, penetração tecidual); (3) Farmacodinâmica diferente (tempo-dependente vs. concentração-dependente); (4) Ligação proteica diferente; (5) Efeito pós-antibiótico diferente. Analogia: comparar CIMs é como comparar tempo de corrida de 100m com tempo de maratona - são 'provas' diferentes. Use interpretação S/I/R e considere contexto clínico, espectro, custo e segurança."
      }
    },
    {
      ...
      content: `
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h3 style="color: #d97706; margin-bottom: 15px;">⚠️ Erro Crítico: Tratar Toda Cultura Positiva</h3>
          <p style="font-size: 16px; line-height: 1.6; margin-bottom: 15px;">
            <strong>Nem toda cultura positiva significa presença de infecção.</strong> A 
            <strong>correlação clínico-laboratorial</strong> é essencial para diferenciação entre 
            <strong>colonização</strong> e <strong>infecção</strong>.
          </p>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 15px 0;">
            <h4 style="color: #92400e; margin-bottom: 10px;">🔬 Definições</h4>
            <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
              <tr style="background: #f59e0b; color: white;">
                <th style="padding: 10px; border: 1px solid #ddd;">Conceito</th>
                <th style="padding: 10px; border: 1px solid #ddd;">Definição</th>
                <th style="padding: 10px; border: 1px solid #ddd;">Tratamento</th>
              </tr>
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Colonização</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">Presença de microrganismos <strong>sem resposta inflamatória</strong> ou sintomas</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #dc2626; font-weight: bold;">NÃO tratar</td>
              </tr>
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>Infecção</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">Presença de microrganismos <strong>com resposta inflamatória</strong> e sintomas</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #059669; font-weight: bold;">Tratar</td>
              </tr>
            </table>
          </div>
        </div>
        ...
        <div style="background: #fee2e2; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #dc2626; margin-bottom: 15px;">❌ Por Que É Um Erro Tratar Colonização?</h4>
          <ol style="margin-left: 20px; line-height: 1.8;">
            <li><strong>Pressão seletiva:</strong> Favorece resistência antimicrobiana</li>
            <li><strong>Efeitos adversos:</strong> Risco sem benefício</li>
            <li><strong>Custo desnecessário:</strong> Desperdício de recursos</li>
            <li><strong>Disbiose:</strong> Alteração da microbiota normal</li>
            <li><strong>Superinfecção:</strong> Risco de <em>C. difficile</em>, candidíase</li>
            <li><strong>Falso senso de segurança:</strong> Não previne infecção futura</li>
          </ol>
        </div>
        
        <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #0369a1; margin-bottom: 15px;">📊 Exemplo Clássico: Bacteriúria Assintomática</h4>
          
          <div style="background: #dbeafe; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #1e40af; margin-bottom: 10px;">🦠 Caso Clínico</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Paciente:</strong> Mulher, 35 anos, saudável<br>
              <strong>Motivo:</strong> Check-up de rotina<br>
              <strong>Sintomas:</strong> <strong>NENHUM</strong> (assintomática)<br>
              <strong>Exame:</strong> Urina tipo I de rotina<br>
              <strong>Resultado:</strong> Leucócitos 10-15/campo, nitritos negativos<br>
              <strong>Urocultura:</strong> <em>E. coli</em> > 100.000 UFC/mL (sensível a todos)
            </p>
          </div>
          
          <div style="background: #fee2e2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #dc2626; margin-bottom: 10px;">❌ Conduta Incorreta</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>"Cultura positiva! Vou prescrever antibiótico!"</strong>
            </p>
            <p style="font-size: 14px; line-height: 1.6; font-weight: bold; color: #991b1b;">
              ⚠️ <strong>ERRO!</strong> Paciente assintomática = bacteriúria assintomática = NÃO tratar!
            </p>
          </div>
          
          <div style="background: #dcfce7; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #059669; margin-bottom: 10px;">✅ Conduta Correta</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>"Paciente assintomática. Não há indicação de tratamento."</strong>
            </p>
            <p style="font-size: 14px; line-height: 1.6; font-weight: bold; color: #166534;">
              ✅ <strong>Correto!</strong> Se não tem sintoma, via de regra, não tem doença.
            </p>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px;">
              <strong>Orientação:</strong> Retornar se desenvolver sintomas (disúria, urgência, polaciúria)
            </p>
          </div>
        </div>
        
        <div style="background: #dcfce7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #059669; margin-bottom: 15px;">✅ Quando Tratar Bacteriúria Assintomática?</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            <strong>Apenas em situações específicas:</strong>
          </p>
          ...
          <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
            ...
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Gestantes</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Risco de pielonefrite (20-40%) e parto prematuro</td>
              <td style="padding: 8px; border: 1px solid #ddd; color: #059669; font-weight: bold;">SIM</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Pré-procedimento urológico</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Risco de bacteremia/sepse pós-procedimento</td>
              <td style="padding: 8px; border: 1px solid #ddd; color: #059669; font-weight: bold;">SIM</td>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Transplante renal</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Risco de pielonefrite no enxerto (imunossupressão)</td>
              <td style="padding: 8px; border: 1px solid #ddd; color: #059669; font-weight: bold;">SIM</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Neutropenia grave</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Risco de sepse (neutrófilos < 500/mm³)</td>
              <td style="padding: 8px; border: 1px solid #ddd; color: #059669; font-weight: bold;">SIM</td>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Mulher saudável</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Sem risco aumentado</td>
              <td style="padding: 8px; border: 1px solid #ddd; color: #dc2626; font-weight: bold;">NÃO</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Idoso</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Sem risco aumentado (exceto se sintomático)</td>
              <td style="padding: 8px; border: 1px solid #ddd; color: #dc2626; font-weight: bold;">NÃO</td>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Diabético</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Sem risco aumentado (exceto se sintomático)</td>
              <td style="padding: 8px; border: 1px solid #ddd; color: #dc2626; font-weight: bold;">NÃO</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Cateter vesical</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Colonização esperada (exceto se sintomático)</td>
              <td style="padding: 8px; border: 1px solid #ddd; color: #dc2626; font-weight: bold;">NÃO</td>
            </tr>
          </table>
        </div>
        ...
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #d97706; margin-bottom: 15px;">🔬 Outros Exemplos de Colonização</h4>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">1. MRSA Nasal</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Situação:</strong> Swab nasal positivo para MRSA em paciente assintomático<br>
              <strong>Conduta:</strong> <strong>NÃO tratar</strong> (exceto descolonização pré-cirurgia cardíaca/ortopédica)
            </p>
          </div>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">2. Pseudomonas em Escarro</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Situação:</strong> <em>P. aeruginosa</em> em escarro de paciente com DPOC estável<br>
              <strong>Conduta:</strong> <strong>NÃO tratar</strong> (exceto se exacerbação aguda)
            </p>
          </div>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">3. Candida em Urina</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Situação:</strong> <em>Candida</em> spp. em urina de paciente com cateter vesical assintomático<br>
              <strong>Conduta:</strong> <strong>NÃO tratar</strong> (remover cateter se possível)
            </p>
          </div>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">4. Enterococo em Ferida</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Situação:</strong> <em>Enterococcus</em> spp. em swab de ferida cirúrgica limpa sem sinais flogísticos<br>
              <strong>Conduta:</strong> <strong>NÃO tratar</strong> (apenas limpeza local)
            </p>
          </div>
        </div>
        
        <div style="background: #eef2ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #4338ca; margin-bottom: 15px;">🩺 Como Diferenciar Colonização de Infecção?</h4>
          
          <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
            <tr style="background: #6366f1; color: white;">
              <th style="padding: 10px; border: 1px solid #ddd;">Critério</th>
              <th style="padding: 10px; border: 1px solid #ddd;">Colonização</th>
              <th style="padding: 10px; border: 1px solid #ddd;">Infecção</th>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Sintomas</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Ausentes</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Presentes (febre, dor, etc.)</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Sinais inflamatórios</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Ausentes</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Presentes (rubor, calor, tumor, dor)</td>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Leucócitos</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Normal ou levemente elevado</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Elevado (leucocitose, desvio à esquerda)</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>PCR/VHS</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Normal</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Elevado</td>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Imagem</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Sem alterações agudas</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Alterações compatíveis (consolidação, abscesso)</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Resposta a antibiótico</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Não aplicável (não tratar)</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Melhora clínica em 48-72h</td>
            </tr>
          </table>
        </div>
        ...
        <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; border-left: 4px solid #0ea5e9; margin: 15px 0;">
          <h4 style="color: #0369a1; margin-bottom: 10px;">💡 Mensagem Chave</h4>
          <p style="font-size: 14px; line-height: 1.6;">
            <strong>Cultura positiva ≠ Infecção.</strong> Correlação clínico-laboratorial é essencial. 
            <strong>Se não tem sintoma, via de regra, não tem doença.</strong> Tratar colonização causa 
            resistência, efeitos adversos e custo sem benefício. Exceções: gestantes, pré-procedimento 
            urológico, transplante renal, neutropenia grave. <strong>Sempre avalie o contexto clínico!</strong>
          </p>
        </div>
      `,
      question: {
        text: "Por que nem toda cultura positiva indica infecção?",
        options: [
          "Porque a presença de microrganismos na cultura sempre indica doença ativa",
          "Porque é necessária a correlação clínico-laboratorial; uma cultura positiva pode representar apenas colonização, especialmente em indivíduos assintomáticos",
          "Porque culturas positivas em mulheres sempre indicam infecção urinária, mesmo sem sintomas"
        ],
        correct: 1,
        explanation: "Cultura positiva pode representar colonização (presença sem resposta inflamatória) ou infecção (presença com resposta inflamatória e sintomas). Correlação clínico-laboratorial é essencial. Exemplo clássico: bacteriúria assintomática em mulher saudável - NÃO tratar (exceto gestantes, pré-procedimento urológico, transplante renal, neutropenia). 'Se não tem sintoma, via de regra, não tem doença.' Tratar colonização causa resistência, efeitos adversos, custo e disbiose. Diferenciar: sintomas, sinais inflamatórios, leucócitos, PCR, imagem."
      }
    },
    {
      ...
      content: `
        <div style="background: #dcfce7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h3 style="color: #059669; margin-bottom: 15px;">🇧🇷 Padronização Nacional: BrCAST</h3>
          <p style="font-size: 16px; line-height: 1.6; margin-bottom: 15px;">
            O Brasil adota o <strong>BrCAST</strong> (Comitê Brasileiro de Testes de Sensibilidade aos 
            Antimicrobianos) como <strong>padrão oficial</strong>, não mais o CLSI (padrão americano), 
            o que implica em <strong>diferenças importantes na interpretação dos resultados</strong>.
          </p>
          
          <div style="background: #f0fdf4; padding: 15px; border-radius: 8px; margin: 15px 0;">
            <h4 style="color: #166534; margin-bottom: 10px;">📅 Histórico da Mudança</h4>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Até 2018:</strong> Brasil seguia CLSI (Clinical and Laboratory Standards Institute - EUA)</li>
              <li><strong>Final de 2018:</strong> Brasil abandonou CLSI e adotou EUCAST (European Committee on Antimicrobial Susceptibility Testing)</li>
              <li><strong>Desde 2018:</strong> Padrão brasileiro = BrCAST (baseado em EUCAST com adaptações locais)</li>
            </ul>
          </div>
        </div>
        
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #d97706; margin-bottom: 15px;">🔄 Principais Diferenças: CLSI vs. BrCAST</h4>
          
          <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
            <tr style="background: #f59e0b; color: white;">
              <th style="padding: 10px; border: 1px solid #ddd;">Aspecto</th>
              <th style="padding: 10px; border: 1px solid #ddd;">CLSI (EUA)</th>
              <th style="padding: 10px; border: 1px solid #ddd;">BrCAST (Brasil)</th>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Origem</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Estados Unidos</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Europa (EUCAST) + adaptações Brasil</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Pontos de corte</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Geralmente mais altos</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Geralmente mais baixos (mais rigorosos)</td>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Categoria "I"</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">"Intermediário" (evitar uso)</td>
              <td style="padding: 8px; border: 1px solid #ddd;">"Sensível com Aumento de Exposição" (pode usar com ajuste)</td>
            </tr>
            <tr style="background: #f9fafb;">
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Filosofia</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Baseado em dados clínicos americanos</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Baseado em PK/PD e dados europeus</td>
            </tr>
            <tr>
              <td style="padding: 8px; border: 1px solid #ddd;"><strong>Atualização</strong></td>
              <td style="padding: 8px; border: 1px solid #ddd;">Anual (janeiro)</td>
              <td style="padding: 8px; border: 1px solid #ddd;">Anual (baseado em EUCAST)</td>
            </tr>
          </table>
        </div>
        
        <div style="background: #fee2e2; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #dc2626; margin-bottom: 15px;">⚠️ Implicação Prática: Pseudomonas aeruginosa</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            Isso é particularmente importante no antibiograma de <strong><em>P. aeruginosa</em> 
            multissensível</strong>. Muitas das drogas que no CLSI apareciam como <strong>"Sensível"</strong>, 
            agora aparecem como <strong>"Sensível com Aumento de Exposição - SAE"</strong> ou, 
            simplesmente, <strong>"Intermediário"</strong>.
          </p>
          
          <div style="background: #fef2f2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #991b1b; margin-bottom: 10px;">🦠 Exemplo Prático</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Paciente:</strong> Homem, 65 anos, pneumonia hospitalar<br>
              <strong>Cultura:</strong> <em>Pseudomonas aeruginosa</em><br>
              <strong>Antibiograma:</strong>
            </p>
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
              <tr style="background: #ef4444; color: white;">
                <th style="padding: 10px; border: 1px solid #ddd;">Antibiótico</th>
                <th style="padding: 10px; border: 1px solid #ddd;">CIM (mg/L)</th>
                <th style="padding: 10px; border: 1px solid #ddd;">CLSI (antigo)</th>
                <th style="padding: 10px; border: 1px solid #ddd;">BrCAST (atual)</th>
              </tr>
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;">Piperacilina/tazobactam</td>
                <td style="padding: 8px; border: 1px solid #ddd;">16</td>
                <td style="padding: 8px; border: 1px solid #ddd; background: #dcfce7; color: #059669; font-weight: bold;">S</td>
                <td style="padding: 8px; border: 1px solid #ddd; background: #fef3c7; color: #d97706; font-weight: bold;">I (SAE)</td>
              </tr>
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;">Ceftazidima</td>
                <td style="padding: 8px; border: 1px solid #ddd;">8</td>
            ...
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px; font-weight: bold; color: #991b1b;">
              ⚠️ <strong>Atenção:</strong> Piperacilina/tazobactam e cefepime que eram "S" no CLSI, 
              agora são "I" (SAE) no BrCAST!
            </p>
          </div>
        </div>
        
        <div style="background: #dcfce7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #059669; margin-bottom: 15px;">✅ Lembre: No BrCAST, "I" ou "SAE" Significa "Sensível"</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            <strong>Mudança conceitual importante:</strong> A categoria "I" no BrCAST <strong>NÃO significa 
            resistência</strong>, mas sim que o antibiótico <strong>pode ser usado</strong> com ajustes de dose 
            ou regime de administração.
          </p>
          
          <div style="background: #f0fdf4; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #166534; margin-bottom: 10px;">🔬 Interpretação das Categorias BrCAST</h5>
            <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
              <tr style="background: #10b981; color: white;">
                <th style="padding: 10px; border: 1px solid #ddd;">Categoria</th>
                <th style="padding: 10px; border: 1px solid #ddd;">Significado</th>
                <th style="padding: 10px; border: 1px solid #ddd;">Conduta</th>
              </tr>
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>S (Sensível)</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">Alta probabilidade de sucesso com dose padrão</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #059669; font-weight: bold;">Usar dose padrão</td>
              </tr>
              <tr style="background: #f9fafb;">
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>I (SAE)</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">Sensível com <strong>aumento de exposição</strong> (dose alta, infusão prolongada)</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #d97706; font-weight: bold;">Usar com ajuste de dose/regime</td>
              </tr>
              <tr>
                <td style="padding: 8px; border: 1px solid #ddd;"><strong>R (Resistente)</strong></td>
                <td style="padding: 8px; border: 1px solid #ddd;">Alta probabilidade de falha mesmo com dose máxima</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #dc2626; font-weight: bold;">NÃO usar</td>
              </tr>
            </table>
          </div>
          
          <div style="background: #ecfdf5; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #065f46; margin-bottom: 10px;">💊 Estratégias de "Aumento de Exposição"</h5>
            <ol style="margin-left: 20px; line-height: 1.8;">
              <li><strong>Aumentar dose:</strong> Ex: Cefepime 2g → 2g 8/8h em vez de 12/12h</li>
              <li><strong>Infusão prolongada:</strong> Ex: Piperacilina/tazobactam infusão de 4h em vez de 30 min</li>
              <li><strong>Reduzir intervalo:</strong> Ex: Meropenem 1g 6/6h em vez de 8/8h</li>
              <li><strong>Aproveitar sítio favorável:</strong> Ex: Quinolonas têm alta concentração urinária</li>
            </ol>
          </div>
        </div>
        
        <div style="background: #eef2ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #4338ca; margin-bottom: 15px;">📊 Exemplo de Ajuste para "I" (SAE)</h4>
          
          <div style="background: #dbeafe; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #1e40af; margin-bottom: 10px;">🦠 Caso Clínico</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>Paciente:</strong> Mulher, 55 anos, pneumonia hospitalar grave<br>
              <strong>Cultura:</strong> <em>Pseudomonas aeruginosa</em><br>
              <strong>Antibiograma:</strong> Piperacilina/tazobactam = <strong>I (SAE)</strong>
            </p>
          </div>
          ...
          <div style="background: #fee2e2; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #dc2626; margin-bottom: 10px;">❌ Conduta Incorreta</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>"É intermediário, então não vou usar. Vou escolher outro antibiótico."</strong>
            </p>
            <p style="font-size: 14px; line-height: 1.6; font-weight: bold; color: #991b1b;">
              ⚠️ <strong>ERRO!</strong> "I" no BrCAST significa sensível com ajuste, não resistência!
            </p>
          </div>
          ...
          <div style="background: #dcfce7; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #059669; margin-bottom: 10px;">✅ Conduta Correta</h5>
            <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
              <strong>"É SAE, então posso usar com ajuste de dose/regime."</strong>
            </p>
            <p style="font-size: 14px; line-height: 1.6; font-weight: bold; color: #166534;">
              ✅ <strong>Prescrição:</strong> Piperacilina/tazobactam 4,5g IV em <strong>infusão prolongada 
              de 4 horas</strong>, 6/6h
            </p>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px;">
              <strong>Justificativa:</strong> Infusão prolongada aumenta T > CIM, otimizando PK/PD para 
              β-lactâmico tempo-dependente
            </p>
          </div>
        </div>
        
        <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 15px 0;">
          <h4 style="color: #d97706; margin-bottom: 15px;">⚠️ Cuidados ao Interpretar Antibiogramas Antigos</h4>
          <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
            Se você encontrar antibiogramas realizados <strong>antes de 2019</strong>, eles provavelmente 
            seguem o padrão CLSI. <strong>Não compare diretamente</strong> com antibiogramas atuais (BrCAST).
          </p>
          
          <div style="background: #fffbeb; padding: 15px; border-radius: 8px; margin: 10px 0;">
            <h5 style="color: #92400e; margin-bottom: 10px;">📅 Exemplo de Confusão</h5>
            <ul style="margin-left: 20px; line-height: 1.8;">
              <li><strong>2017 (CLSI):</strong> Piperacilina/tazobactam = S</li>
              <li><strong>2023 (BrCAST):</strong> Piperacilina/tazobactam = I (SAE)</li>
            </ul>
            <p style="font-size: 14px; line-height: 1.6; margin-top: 10px; font-weight: bold; color: #78350f;">
              ⚠️ <strong>Não significa que a bactéria ficou mais resistente!</strong> É apenas mudança de 
        ...
        <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; border-left: 4px solid #0ea5e9; margin: 15px 0;">
          <h4 style="color: #0369a1; margin-bottom: 10px;">💡 Mensagem Chave</h4>
          <p style="font-size: 14px; line-height: 1.6;">
            <strong>Brasil adotou BrCAST (baseado em EUCAST) desde 2018.</strong> Principais diferenças: 
            pontos de corte mais rigorosos, categoria "I" significa "Sensível com Aumento de Exposição" 
            (SAE), não resistência. Para <em>P. aeruginosa</em>, muitas drogas que eram "S" no CLSI agora 
            são "I" (SAE) no BrCAST. <strong>Lembre: "I" ou "SAE" = pode usar com ajuste de dose/regime!</strong> 
            Estratégias: dose alta, infusão prolongada, intervalo reduzido.
          </p>
        </div>
      `,
      question: {
        text: "No Brasil, qual é o padrão oficial para interpretação de antibiogramas e qual é a implicação prática dessa mudança para Pseudomonas aeruginosa multissensível?",
        options: [
          "O Brasil continua usando o CLSI; portanto, todas as drogas listadas como 'Sensível' significam sensibilidade plena",
          "O Brasil adotou o BrCAST, e valores interpretados como 'I' (intermediário) ou 'SAE' (sensível com aumento de exposição) devem ser considerados sensíveis na prática clínica",
          "O BrCAST considera todas as drogas 'Intermediárias' como resistentes, o que limita opções terapêuticas"
        ],
        correct: 1,
        explanation: "Brasil adotou BrCAST (baseado em EUCAST) desde final de 2018, abandonando CLSI. Mudança conceitual importante: categoria 'I' no BrCAST significa 'Sensível com Aumento de Exposição' (SAE), não resistência. Pode usar com ajuste: (1) Dose alta; (2) Infusão prolongada; (3) Intervalo reduzido; (4) Sítio favorável. Para P. aeruginosa: muitas drogas que eram 'S' no CLSI agora são 'I' (SAE) no BrCAST (ex: piperacilina/tazobactam, cefepime). Pontos de corte BrCAST são mais rigorosos (mais baixos) que CLSI."
      }
    }
  ]
}
  ...
  sections: [
    {
      ...
      content: `
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 25px; border-radius: 10px; color: white; margin-bottom: 20px;">
          <h2 style="color: white; margin-bottom: 10px;">📝 Revisão Parte I - Fundamentos</h2>
          <p style="font-size: 16px; line-height: 1.6;">
            <strong>15 perguntas</strong> sobre conceitos fundamentais do TSA
          </p>
        </div>
        
        <div style="background: #fef3c7; padding: 15px; border-radius: 8px; margin-bottom: 15px;">
          <h4 style="color: #92400e; margin-bottom: 8px;">📚 Tópicos</h4>
          <ul style="line-height: 1.6; color: #78350f; margin: 0;">
            <li>Papel do laboratório de microbiologia</li>
            <li>Resistência intrínseca vs. adquirida</li>
            <li>Heterorresistência e CIM</li>
          </ul>
        </div>
      `,
      question: {
        text: "Pronto para começar a revisão dos fundamentos?",
        options: ["Sim, vamos começar!", "Revisar antes", "Fazer depois"],
        correct: 0,
        explanation: "Ótimo! Vamos revisar os conceitos fundamentais do TSA."
      }
    }
  ]
},
  ...
  sections: [
    {
      ...
      content: `
        <div style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 25px; border-radius: 10px; color: white; margin-bottom: 20px;">
          <h2 style="color: white; margin-bottom: 10px;">📝 Revisão Parte II - Métodos</h2>
          <p style="font-size: 16px; line-height: 1.6;">
      ...
      `,
      question: {
        text: "Pronto para revisar os métodos de TSA?",
        options: ["Sim!", "Não", "Depois"],
        correct: 0,
        explanation: "Vamos revisar os métodos!"
      }
    }
  ]
},
  ...
  sections: [
    {
      ...
      content: `
        <div style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); padding: 25px; border-radius: 10px; color: white; margin-bottom: 20px;">
          <h2 style="color: white; margin-bottom: 10px;">📝 Revisão Parte III - Interpretação</h2>
          <p style="font-size: 16px; line-height: 1.6;">
            <strong>16 perguntas</strong> sobre interpretação e sistemas automatizados
          </p>
        </div>
      `,
      question: {
        text: "Pronto para revisar interpretação de resultados?",
        options: ["Sim!", "Não", "Depois"],
        correct: 0,
        explanation: "Vamos revisar interpretação!"
      }
    }
  ]
},
  ...
  sections: [
    {
      ...
      content: `
        <div style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); padding: 25px; border-radius: 10px; color: white; margin-bottom: 20px;">
          <h2 style="color: white; margin-bottom: 10px;">📝 Revisão Parte IV - Tópicos Avançados</h2>
          <p style="font-size: 16px; line-height: 1.6;">
            <strong>15 perguntas</strong> sobre conceitos avançados e erros comuns
          </p>
        </div>
      `,
      question: {
        text: "Pronto para os tópicos avançados?",
        options: ["Sim!", "Não", "Depois"],
        correct: 0,
        explanation: "Vamos aos tópicos avançados!"
      }
    }
  ]
},
