          ...
          sections: [
            {
              ...
              content: `
                ...
                <div style="background: #eff6ff; padding: 20px; border-radius: 8px; margin: 15px 0; border-left: 4px solid #3b82f6;">
                  ...
                  <p style="font-size: 15px; line-height: 1.6; color: #1e3a8a; margin: 0;">
                    Ligam-se aos <strong>ribossomos bacterianos</strong>, impedindo a síntese proteica essencial para o crescimento e sobrevivência da bactéria.
                  </p>
                </div>
              ...
              question: {
                ...
                options: [
                  ...
                  "B) Ligam-se aos ribossomos bacterianos, impedindo a síntese proteica essencial",
                  "C) Destroem a membrana celular bacteriana",
                  "D) Inibem a replicação do DNA bacteriano"
                ],
                correct: 1,
                explanation: "Os inibidores da síntese proteica atuam ligando-se aos ribossomos bacterianos, impedindo a síntese de proteínas essenciais para o crescimento e sobrevivência da bactéria. Diferentes classes atuam em diferentes subunidades ribossomais: a subunidade 30S (aminoglicosídeos, tetraciclinas) ou a subunidade 50S (macrolídeos, lincosamidas, fenicol, oxazolidinonas)."
              }
            }
          ]
        },
