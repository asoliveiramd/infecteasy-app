              ...
              content: `
                <div style="background: #f3e8ff; padding: 20px; border-radius: 8px; margin: 15px 0;">
                  ...
                  <div style="background: #faf5ff; padding: 15px; border-radius: 8px; margin: 10px 0;">
                    <h4 style="color: #6b21a8; margin-bottom: 10px;"><abbr title="Methicillin-Resistant Staphylococcus aureus - Estafilococo resistente à meticilina" style="text-decoration: underline dotted; cursor: help; border: none;">MRSA</abbr></h4>
                    <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
                      <strong>Mecanismo:</strong> <abbr title="Penicillin-Binding Protein 2a - Proteína alterada que confere resistência em MRSA" style="text-decoration: underline dotted; cursor: help; border: none;">PBP2a</abbr> (resistente a todos β-lactâmicos)
                    </p>
                    <p style="font-size: 14px; line-height: 1.6;">
                  ...
                  <div style="background: #fef2f2; padding: 15px; border-radius: 8px; margin: 10px 0;">
                    <h4 style="color: #991b1b; margin-bottom: 10px;"><abbr title="Vancomycin-Resistant Enterococcus - Enterococo resistente à vancomicina" style="text-decoration: underline dotted; cursor: help; border: none;">VRE</abbr></h4>
                    <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px;">
                      <strong>Mecanismo:</strong> <abbr title="Modificação do peptideoglicano que confere resistência à vancomicina em VRE" style="text-decoration: underline dotted; cursor: help; border: none;">D-Ala-D-Lac</abbr> (resistente a vancomicina)
                    </p>
                    <p style="font-size: 14px; line-height: 1.6;">
